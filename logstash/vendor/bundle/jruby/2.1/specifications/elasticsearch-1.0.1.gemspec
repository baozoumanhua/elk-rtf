# -*- encoding: utf-8 -*-
# stub: elasticsearch 1.0.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<elasticsearch-transport>, ["= 1.0.1"])
      s.add_runtime_dependency(%q<elasticsearch-api>, ["= 1.0.1"])
      ...
      s.add_dependency(%q<elasticsearch-transport>, ["= 1.0.1"])
      s.add_dependency(%q<elasticsearch-api>, ["= 1.0.1"])
